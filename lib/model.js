...
AbstractClass.update = function (params, cb) {
    if (stillConnecting(this.schema, this, arguments,cb)) return;
    var Model = this;
...
AbstractClass.create = function (data, callback) {
    if (stillConnecting(this.schema, this, arguments,callback)) return;
    ...
    var options = data.options || { validate: false };
...
function stillConnecting(schema, obj, args,callback) {
...
AbstractClass.prototype.save = function (options, callback) {
    if (stillConnecting(this.constructor.schema, this, arguments,cb)) return;
...
AbstractClass.prototype.updateAttributes = function updateAttributes(data, callback) {
    if (stillConnecting(this.constructor.schema, this, arguments,callback)) return;
